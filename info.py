...
API_ID = int(environ.get('API_ID', '21632299'))
API_HASH = environ.get('API_HASH', '9bc9bb6bb0bdb463726fc298ae652387')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5482745712').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001851682672').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://freeserverka:kaif34@cluster0.nn66qpb.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002124106205'))
